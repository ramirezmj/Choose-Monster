...
//@interface ChooseMonsterObject : NSObject
//@end

@interface ChooseMonsterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ChooseMonsterObject class]])
		{
			for (NSString *key in [[(ChooseMonsterObject*)o modules] allKeys])
			{
