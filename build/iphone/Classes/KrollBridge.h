...
@interface ChooseMonsterObject : KrollCoverageObject {
#else
@interface ChooseMonsterObject : KrollObject {
#endif
@private
...
extern NSString * ChooseMonster$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ChooseMonsterObject *_choosemonster;
    KrollObject* console;
	BOOL shutdown;
