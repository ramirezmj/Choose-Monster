...
//Rare exceptions to indicate a bug in the _choosemonster code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ChooseMonster proxies.
 */
