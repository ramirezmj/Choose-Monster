...
// in simulator we redefine to format for ChooseMonster Developer console
...
{\
	NSString * exceptionName = [@"org.choosemonster." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.choosemonster";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIChooseMonsterNativeItemNone = -1, 
	UIChooseMonsterNativeItemSpinner = -2,
	UIChooseMonsterNativeItemProgressBar = -3,
	
	UIChooseMonsterNativeItemSlider = -4,
	UIChooseMonsterNativeItemSwitch = -5,
	UIChooseMonsterNativeItemMultiButton = -6,
	UIChooseMonsterNativeItemSegmented = -7,
	
	UIChooseMonsterNativeItemTextView = -8,
	UIChooseMonsterNativeItemTextField = -9,
	UIChooseMonsterNativeItemSearchBar = -10,
	
	UIChooseMonsterNativeItemPicker = -11,
	UIChooseMonsterNativeItemDatePicker = -12,
	
	UIChooseMonsterNativeItemInfoLight = -13,
	UIChooseMonsterNativeItemInfoDark = -14,
	
	UIChooseMonsterNativeItemDisclosure = -15,
	
	UIChooseMonsterNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all ChooseMonster instances of
